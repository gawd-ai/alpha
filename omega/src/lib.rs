//! omega — the **Ω** of GAWD: the highest set-of-sets, the final membrane.
//!
...
/// `omega`. A real federation creature emits its own richer replies under other schemas.
pub mod deferred {
    use realm::RealmId;
