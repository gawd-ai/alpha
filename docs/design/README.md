...
- [The substrate: creatures, the ABI, and the tiers](substrate.md) — the three execution tiers,
  daemon/beast `gawd_creature_v1` and critter `gawd_critter_v1` ABIs, the signed manifest, safe
  unload, and the capability model.
