...
|---|---|---|
| [`critters/`](critters) | Rhai **script-tier creatures** | `echo-critter`, `uppercase`, `rot13`, `contains`, `kv-extract`, `route-by-prefix` |
| [`policies/`](policies) | admission `Policy`, `RestorePolicy`, `QuarantineTrust`, budget policy | `policy-dev / -signed / -budget / -abode-allowlist / -prefer-promoted / -quarantine-{aware,trust-all,trust-realm}` |
